    ...
    return (
        <div className='px-4 sm:px-20 xl:px-32 my-24'>
            <div className='text-center'>
                <h2 className='text-slate-700 text-[42px] font-semibold'>AI-Powered Tools for Creators</h2>
                <p className='text-gray-500 max-w-lg mx-auto'>Everything you need to write articles, generate images, remove backgrounds, and polish your content using advanced AI models.</p>
            </div>
